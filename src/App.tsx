...
const App = () => {
  ...
  return (
    <main>
      ...
      Могу самостоятельно решить большинство возникающих вопросов, но также буду рада хорошему ментору в команде. </p>       
        <p>Ценю атмосферу дружелюбия и понимания. В приоритете удаленная работа.</p>
        <p>Ранее обучалась в МИРЭА на инженера в области радиоэлектроники, но решила оставить университет в пользу обучения разработке. Имеется опыт в сфере продаж и другой технической сфере.</p>
